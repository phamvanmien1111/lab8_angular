...
dotenv.config();
export const lienhe =  async (req:Request , res:Response)=>{
    try{
...
export const sendEmail = async (firstName:string ,lastName:string ,  email:string , message:string ,purpose:string , createdAt:Date)=>{
...
export const postContact = async (req: Request, res: Response) => {
    try {
        ...
        await sendEmail(firstName, lastName, email, message, purpose, createdAt);
